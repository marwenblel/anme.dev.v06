(function ($) {
    function replaceClassByCol() {
        ...
        if (width >= 300 && width <= 760) {
            var sidebarSecond = document.querySelector('body.page-type-news_events #sidebar-second');
            var content = document.querySelector('body.page-type-news_events #content');
